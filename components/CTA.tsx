        ...
        <SectionFade anim="zoom">
          <div className="relative">
            ...
            <div className="relative bg-[#0d1526] border border-indigo-500/20 rounded-3xl px-8 py-16">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-white mb-4 leading-tight">{t('heading')}</h2>
              <p className="text-slate-400 text-lg mb-10 max-w-xl mx-auto leading-relaxed">{t('desc')}</p>
